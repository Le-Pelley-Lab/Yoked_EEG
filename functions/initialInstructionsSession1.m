...
instructStr1 = 'On each trial a cross will appear, this to warn you that the trial is about to start. Then a set of shapes will appear; two examples are shown below.';
if keyCounterbal == 1
    word1 = 'HORIZONTAL';
    word2 = 'VERTICAL';
else
...
instructStr3 = ['If the line inside the target is ', word1,', you should press the "C" button. If the line is ',word2,', you should press the "M" button.'];
